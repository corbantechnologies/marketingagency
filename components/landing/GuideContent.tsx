...
export function GuideContent() {
  ...
  const guideSections: GuideSection[] = [
    ...
    },
    {
      ...
      category: "messaging",
      stepNumber: "05",
      title: "Composing & Launching Bulk SMS Campaigns",
      badge: "Campaign Engine",
      summary:
        "Write your promotional blast or alert message, insert personalized dynamic tags, check real-time GSM segment boundaries, and preview on a virtual handset before sending.",
      keyActionLink: { label: "Open SMS Composer", href: "/business/sms/broadcast" },
      highlights: [
        "Live GSM 03.38 calculator: 160 characters for a single SMS; 153 characters per part for multi-segment messages.",
        "Click dynamic pills (+ {first_name}) to insert personalized recipient tags at your cursor.",
        "Variable-length inflation warning alerts you when your message is close to the 160-char boundary.",
        "Interactive Smartphone Mockup displays how your message looks to recipients.",
        "Asynchronous dispatch engine ensures 10,000+ messages queue in <100ms without browser freezes.",
      ],
      tips: "Promotional bulk SMS in Kenya is legally permitted between 8:00 AM and 7:00 PM. Always include your business name or opt-out instructions.",
    },
    {
      id: "sec-6",
      category: "messaging",
      stepNumber: "06",
      title: "Monitoring Real-Time Delivery Reports (DLR)",
      badge: "Analytics & Telemetry",
      summary:
        "Track message delivery performance in real-time as telco carriers report back handset arrival receipts, delivery timestamps, and network routing.",
      keyActionLink: { label: "View Delivery Reports", href: "/business/reports" },
      highlights: [
        "Inspect statuses: DELIVERED, SENT, FAILED, or UNDELIVERABLE.",
        "Carrier detection automatically categorizes Safaricom, Airtel, and Telkom numbers.",
        "Search by phone number or gateway message ID to investigate delivery issues.",
        "View overall delivery success rates and weekly volume trends.",
      ],
      tips: "Handset delivery reports generally arrive from Kenyan carriers within 1.5 to 5 seconds after dispatch.",
    },
    {
      id: "sec-7",
      category: "developer",
