...
export function GuideContent() {
  ...
  const guideSections: GuideSection[] = [
    ...
    },
    {
      ...
      category: "compliance",
      stepNumber: "02",
      title: "Setting Up Channels: WhatsApp Business & SMS Sender IDs",
      badge: "Brand Identity & Channels",
      summary:
        "Manage how your messages reach customer handsets. Send WhatsApp broadcasts immediately via LJK's verified route or connect your own dedicated brand number, and whitelist an alphanumeric SMS Sender ID for telecom broadcasts.",
      keyActionLink: { label: "Manage Channels & Sender IDs", href: "/auth/login" },
      highlights: [
        "Default WhatsApp Sender: Send WhatsApp broadcasts immediately through LJK Marketing Agency's verified route (zero Facebook or Meta setup required).",
        "Dedicated WhatsApp Number: Connect your own business WhatsApp number in ~60 seconds via Facebook Login to display your company name and receive direct customer replies.",
        "Alphanumeric SMS Sender ID: Whitelist your official 11-character brand header (e.g. YOURBRAND) with Safaricom and Airtel Kenya.",
        "Review & Activation: SMS headers typically approve in 12–24 business hours; WhatsApp sends immediately.",
      ],
      tips: "Small businesses without a Facebook account can start sending WhatsApp blasts right away via LJK's verified route, with zero technical setup.",
    },
    {
      id: "sec-3",
      category: "messaging",
    ...
    },
    {
      ...
      category: "developer",
      stepNumber: "07",
      title: "Developer REST API & Cryptographic Key Management",
      badge: "REST & Security",
      summary:
        "Connect bulk messaging directly into your custom website, mobile app, CRM, or accounting ERP using our high-speed JSON REST API and cryptographic API keys.",
      keyActionLink: { label: "Open Developer Documentation", href: "/docs" },
      highlights: [
        "Generate cryptographically secure API keys prefixed with ljk_live_ from your Business Portal.",
        "Keys are SHA-256 hashed and never stored in plaintext on our database.",
        "Authenticate every request via the standard HTTP header: X-API-Key: ljk_live_...",
        "One-click key revocation immediately blocks compromised credentials across all clusters.",
      ],
      tips: "You can view full interactive code samples in cURL, Python, JavaScript, and PHP in our public Developer Documentation Hub.",
    },
    {
      id: "sec-8",
      category: "developer",
      stepNumber: "08",
      title: "Programmatic Message Dispatch & Real-Time Blue Ticks Telemetry",
      badge: "Meta Cloud API & SMS",
      summary:
        "Dispatch single transactional OTP alerts or batch campaigns up to 1,000 recipients at a time, and poll delivery status with live Blue Ticks read telemetry.",
      keyActionLink: { label: "View API Reference", href: "/docs" },
      highlights: [
        "POST /api/v1/integrations/dispatch/single/ delivers real-time WhatsApp templates or SMS alerts.",
        "POST /api/v1/integrations/dispatch/batch/ handles up to 1,000 recipients in a single HTTP request.",
        "GET /api/v1/integrations/dispatch/status/<ref>/ returns delivery timestamps and Blue Ticks (is_read: true).",
        "Meta Cloud API v19.0 WABA ID: 2660518117713455 guarantees official verified business checkmarks.",
      ],
      tips: "Use your own custom reference_id (e.g. ORD-9842) so your backend can track delivery without maintaining LJK ID mappings.",
    },
    {
      id: "sec-9",
      category: "developer",
      stepNumber: "09",
      title: "Developer Sandbox Environment & Guaranteed Zero-Cost Refunds",
      badge: "Testing & Billing",
      summary:
        "Test your code risk-free in our developer sandbox without expending real M-PESA funds. Enjoy automatic credit refunds if carriers ever reject an unallocated phone number.",
      keyActionLink: { label: "Learn About Sandbox & Billing", href: "/docs" },
      highlights: [
        "Test API keys (ljk_test_...) route to our simulation engine with 1,000 free virtual sandbox credits.",
        "Simulate delivery lifecycle and WhatsApp Blue Ticks read events without sending real messages.",
        "Atomic ledger lock (select_for_update) prevents double-spending and ensures 100% financial accuracy.",
        "Guaranteed Zero-Cost Carrier Rejection: If a telco or Meta rejects an unallocated number, credits are automatically refunded to your wallet.",
      ],
      tips: "Check your remaining balance anytime before large batch dispatches using GET /api/v1/integrations/balance/.",
    },
  ];
