        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <h1 className="text-xl font-semibold text-zinc-900 tracking-tight leading-snug mb-4">
              Engage 98% of Kenyan Customers on WhatsApp — Powered by Meta Cloud API & Universal Bulk SMS
            </h1>

            {/* Subheading / Value Proposition */}
            <p className="text-base font-normal text-zinc-600 leading-relaxed mb-8 max-w-xl">
              LJK Marketing Agency delivers high-converting Meta WhatsApp Business broadcasts with
              rich image flyers, interactive CTA buttons, real-time Blue Ticks, and automated Tier-1
              Bulk SMS fallback that turns customer contacts into repeat revenue.
            </p>
            ...
            <form onSubmit={handleQuickAudit} className="w-full max-w-lg mb-8">
              <div className="flex flex-col sm:flex-row gap-2.5 p-1.5 bg-zinc-50 border border-zinc-300 rounded shadow-xs">
                <input
                  type="text"
                  required
                  placeholder="Enter business phone or website"
                  value={phoneOrEmail}
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded text-xs sm:text-sm font-semibold transition-colors shadow-xs shrink-0 cursor-pointer"
                >
                  <span>{submitted ? "Preparing Audit..." : "Get Free Campaign Audit"}</span>
              ...
              <p className="text-xs text-zinc-500 mt-2 flex items-center gap-1.5">
                ...
                Includes WhatsApp audience audit & carrier route benchmark report.
              </p>
            </form>
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs font-medium text-zinc-600">
              <span className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded bg-emerald-500" /> Meta Cloud API (Official)
              </span>
              <span className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded bg-sky-500" /> Real-time Blue Ticks (✓✓)
              </span>
              <span className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded bg-[#581c87]" /> Tier-1 SMS Fallback
              </span>
              <span className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded bg-[#581c87]" /> Unified Credit Wallet
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white border border-zinc-200 rounded p-6 shadow-xs relative">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3.5 bg-emerald-50/50 border border-emerald-100 rounded">
                  <div className="text-xs font-medium text-emerald-800 mb-1">WhatsApp Open Rate</div>
                  <div className="text-xl font-semibold text-emerald-700">98.0%</div>
                  <div className="text-xs font-medium text-emerald-600 mt-1 flex items-center gap-1">
                    <span>Meta Cloud API</span>
                    <span className="text-zinc-400 font-normal">· Blue Ticks</span>
                  </div>
                </div>

                <div className="p-3.5 bg-zinc-50 border border-zinc-100 rounded">
                  <div className="text-xs font-medium text-zinc-500 mb-1">Bulk SMS Delivery</div>
                  <div className="text-xl font-semibold text-[#581c87]">99.4%</div>
                  <div className="text-xs font-medium text-[#581c87] mt-1 flex items-center gap-1">
                ...
                <div className="p-3.5 bg-zinc-50 border border-zinc-100 rounded">
                  ...
                  <div className="text-xl font-semibold text-zinc-900">18.5M+</div>
                  <div className="text-xs font-medium text-zinc-500 mt-1">WhatsApp & SMS Live</div>
                </div>

                <div className="p-3.5 bg-zinc-50 border border-zinc-100 rounded">
                  <div className="text-xs font-medium text-zinc-500 mb-1">Avg. Gateway Latency</div>
                  <div className="text-xl font-semibold text-zinc-900">&lt;1.8s</div>
                  <div className="text-xs font-medium text-zinc-500 mt-1">Sub-Second Dispatch</div>
                </div>
              </div>

              {/* Live Status Highlight */}
              <div className="mt-5 pt-4 border-t border-zinc-100 flex items-center justify-between text-xs">
                <span className="text-zinc-500 font-normal">Protocols: Meta Cloud / SMPP 3.4 / REST</span>
                <span className="font-medium text-emerald-700">Capacity: 80,000 Msg / min</span>
              </div>
            </div>
          </div>
