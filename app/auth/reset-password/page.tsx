...
import { useConfirmResetPassword } from "@/hooks/accounts/actions";
...
function ResetPasswordForm() {
  ...
  const isSubmitting = confirmResetMutation.isPending;
    ...
    <div className="bg-white border border-zinc-200 rounded-lg p-6 sm:p-8 shadow-xs">
      <div className="mb-6">
        ...
        <p className="text-xs text-zinc-600 mt-1">
          Provide the 6-digit OTP sent to your email to configure your new password.
        </p>
      </div>
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-xs text-zinc-500">Loading reset form...</div>}>
      <ResetPasswordForm />
    </Suspense>
  );
}